...
public class Karatsuba {
	public static BigInteger multiply(BigInteger x, BigInteger y){
        ...
        result = result.add(padWithZeros(step1, String.valueOf(step3).length()));
        result = result.add(BigInteger.valueOf(step2));
        result = result.add(padWithZeros(step4,  String.valueOf(step3).length()/2 + (String.valueOf(step3).length() % 2)));
        
        return result;
	}
	private static BigInteger padWithZeros(long value, long num2pad){
